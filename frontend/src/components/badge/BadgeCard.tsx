...
function BadgeIcon({ icon, colors }: { icon: React.ReactNode; colors: string[] }) {
  return (
    <div
...
export function BadgeCard({ badge, isClaimed, disabled, onClaim, labelOverride, isWalletReady = true }: {
  badge: { id: number; name: string; rarity: string; desc: string; icon: React.ReactNode; colors: string[] };
  isClaimed: boolean;
  disabled: boolean;
  onClaim: (badge: any) => void;
